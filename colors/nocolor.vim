" adopted carbonized-dark

"=== SET COLOUR VARIABLES =====================================================

" GUI colours
let s:g0 = '2b2b2b'
" status bar, cursor line, gutter
let s:g1 = '3b3b37'
" vertical resizer for window split
let s:g2 = '75756e'
" background color of the line number
let s:g3 = '8a8a81'
" background color of the line number
let s:g4 = '9e9e95'
" text
...
" commented-out text
cal <sid>h('Comment'          , s:gB , ''   , s:t3 , ''   , 'none'      , ''  )
cal <sid>h('Conceal'          , s:gB , ''   , s:t3 , ''   , 'none'      , ''  )
cal <sid>h('EndOfBuffer'      , s:gB , ''   , s:t3 , ''   , 'none'      , ''  )
cal <sid>h('Ignore'           , s:gB , ''   , s:t3 , ''   , 'none'      , ''  )
cal <sid>h('NonText'          , s:gB , ''   , s:t3 , ''   , 'none'      , ''  )
...
cal <sid>h('Define'           , s:gF , ''   , s:t5 , ''   , 'none'      , ''  )
cal <sid>h('IncSearch'        , s:gF , s:g0 , s:t5 , s:t0 , 'reverse'   , ''  )
cal <sid>h('Include'          , s:gF , ''   , s:t5 , ''   , 'none'      , ''  )
cal <sid>h('Macro'            , s:gF , ''   , s:t5 , ''   , 'none'      , ''  )
cal <sid>h('PreCondit'        , s:gF , ''   , s:t5 , ''   , 'none'      , ''  )
cal <sid>h('PreProc'          , s:gF , ''   , s:t5 , ''   , 'none'      , ''  )
...
" WHITE for action elements
cal <sid>h('Conditional'      , s:q6 , ''   , s:tB , ''   , 'none'      , ''  )
cal <sid>h('DiffAdd'          , s:q6 , s:g0 , s:tB , s:t0 , 'reverse'   , ''  )
cal <sid>h('Exception'        , s:q6 , ''   , s:tB , ''   , 'none'      , ''  )
cal <sid>h('Keyword'          , s:q6 , ''   , s:tB , ''   , 'none'      , ''  )
cal <sid>h('Label'            , s:q6 , ''   , s:tB , ''   , 'none'      , ''  )
cal <sid>h('ModeMsg'          , s:q6 , ''   , s:tB , ''   , 'none'      , ''  )
cal <sid>h('MoreMsg'          , s:q6 , ''   , s:tB , ''   , 'none'      , ''  )
cal <sid>h('Operator'         , s:q6 , ''   , s:tB , ''   , 'none'      , ''  )
cal <sid>h('Question'         , s:q6 , ''   , s:tB , ''   , 'none'      , ''  )
cal <sid>h('Repeat'           , s:q6 , ''   , s:tB , ''   , 'none'      , ''  )
cal <sid>h('Statement'        , s:q6 , ''   , s:tB , ''   , 'none'      , ''  )

" TEAL for object types
cal <sid>h('SpellLocal'       , ''   , ''   , s:t0 , s:tC , 'undercurl' , s:gC)
cal <sid>h('StorageClass'     , s:g5 , ''   , s:tC , ''   , 'none'      , ''  )
cal <sid>h('Structure'        , s:g5 , ''   , s:tC , ''   , 'none'      , ''  )
cal <sid>h('Type'             , s:g5 , ''   , s:tC , ''   , 'none'      , ''  )
cal <sid>h('Typedef'          , s:g5 , ''   , s:tC , ''   , 'none'      , ''  )

" BLUE for constants
cal <sid>h('Boolean'          , s:g5 , ''   , s:tD , ''   , 'none'      , ''  )
cal <sid>h('Character'        , s:gD , ''   , s:tD , ''   , 'none'      , ''  )
cal <sid>h('Constant'         , s:g5 , ''   , s:tD , ''   , 'none'      , ''  )
cal <sid>h('Float'            , s:g5 , ''   , s:tD , ''   , 'none'      , ''  )
cal <sid>h('Number'           , s:g5 , ''   , s:tD , ''   , 'none'      , ''  )
